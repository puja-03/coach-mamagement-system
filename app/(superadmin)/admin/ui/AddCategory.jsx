"use client"
import { handleSubmitCategory } from "@/app/action";
import toast from "react-hot-toast";

const AddCategory = () => {

    const handleSubmitCat = async (formData)=>{
        await handleSubmitCategory(formData)
        toast.success("category created successfully")
    }
    return (
        <form className="max-w-md mx-auto bg-slate-200 p-3" action={handleSubmitCat}>
